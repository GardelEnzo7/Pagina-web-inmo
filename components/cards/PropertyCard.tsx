...
return (
    <Link href={`/propiedades/${property.id}`} className="block hover:shadow-xl transition-shadow duration-300 rounded-lg">
        ...
        <CardContent className="p-6 flex flex-col flex-grow">
            ...
            <p className="text-gray-600 text-sm mb-4 flex-grow">{property.description}</p>
                <Link href={`/propiedades/${property.id}`} className="mt-auto">
                    <Button className="w-full bg-[#3B4D5B] hover:bg-[#2c3a47]">
                        Ver Detalles
                    </Button>
                </Link>
        </CardContent>
